...
@section('content')
    <div id="pcont" class="container-fluid">
        <div class="page-head">
            <h2 style="display:inline-block;">Especialidad</h2>
                    ...
                    <div class="tab-container">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="tp2" class="tab-pane cont">
                                <div class="container">
                                    <form id="frmEspecialidad" method="post" data-parsley-validate="" data-parsley-excluded="[disabled=disabled]" novalidate="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input id="txtAbreviatura" type="text" placeholder="Ejem. DOC,FIS,HIST" class="form-control"
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#frmEspecialidad").parsley();
            listar();
        });

        function guardar(){
            var accion = $("#hddCodigo").val() == "" ? true : false;
            if($("#frmEspecialidad").parsley().validate()){
                if (accion)
                    registrar()
                else
                    modificar()
        ...
        function modificar() {
            if (confirm("¿Deseas continuar la modificación?")) {
                var info = obtenerDatos();
                $.ajax({
                    url: "/intranet/mantenimientos/especialidad/" + $("#hddCodigo").val(),
                    type: "PUT",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
        ...
        function eliminar(id) {
            if (confirm("¿Deseas eliminar el elemento?")) {
                ...
                $.ajax({
                    url: "/intranet/mantenimientos/especialidad/" + id,
                    type: "DELETE",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
