...
@section('content')
    <div id="pcont" class="container-fluid">
        <div class="page-head">
            <h2 style="display:inline-block;">Nivel Académico</h2>
                    ...
                    <div class="tab-container">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="tp2" class="tab-pane cont">
                                <div class="container">
                                    <form id="frmNivel" method="post" data-parsley-validate="" data-parsley-excluded="[disabled=disabled]" novalidate="">
    ...
    <script type="text/javascript">
        ...
        function modificar() {
            if (confirm("¿Deseas continuar la modificación?")) {
                var info = obtenerDatos();
                $.ajax({
                    url: "/intranet/mantenimientos/nivel/" + $("#hddCodigo").val(),
                    type: "PUT",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
