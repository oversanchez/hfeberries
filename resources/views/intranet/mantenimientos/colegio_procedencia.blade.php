...
@section('content')
    <div id="pcont" class="container-fluid">
        <div class="page-head">
            <h2 style="display:inline-block;">Colegios de Procedencia</h2>
                    ...
                    <div class="tab-container">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="tp2" class="tab-pane cont">
                                <div class="container">
                                    <form id="frmColegio_Procedencia" method="post" data-parsley-validate="" data-parsley-excluded="[disabled=disabled]" novalidate="">
                                        <input type="hidden" id="hddCodigo" value="">
                                        <div class="row">
                                            <label for="txtNombre" class="col-md-1 control-label">Nombre</label>
                                            <div class="col-md-5">
                                                <input id="txtNombre" type="text" placeholder="Ejem. I.E. SAN JOSE,I.E. COSOME" class="form-control"
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#frmColegio_Procedencia").parsley();
            listar();
        });

        function guardar(){
            var accion = $("#hddCodigo").val() == "" ? true : false;
            if($("#frmColegio_Procedencia").parsley().validate()){
                if (accion)
                    registrar()
                else
                    modificar()
        ...
        function registrar() {
            if (confirm("¿Deseas continuar el registro?")) {
                ...
                $.ajax({
                    url: "/intranet/mantenimientos/colegio_procedencia",
                    type: "POST",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
        ...
        function modificar() {
            if (confirm("¿Deseas continuar la modificación?")) {
                var info = obtenerDatos();
                $.ajax({
                    url: "/intranet/mantenimientos/colegio_procedencia/" + $("#hddCodigo").val(),
                    type: "PUT",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
        ...
        function eliminar(id) {
            if (confirm("¿Deseas eliminar el elemento?")) {
                ...
                $.ajax({
                    url: "/intranet/mantenimientos/colegio_procedencia/" + id,
                    type: "DELETE",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
        ...
        function cancelar(){
            ...
            $('#frmColegio_Procedencia').parsley().reset();
            $('a[href="#tp1"]').click();
