...
@section('content')
    <div id="pcont" class="container-fluid">
        <div class="page-head">
            <h2 style="display:inline-block;">Estados de Tramite</h2>
                        ...
                        <div class="tab-content">
                            <div id="tp1" class="tab-pane active cont">
                                <table class='table table-bordered dataTable no-footer' id="tblListado">
                                    <thead>
                                    <tr>
                                        <th style="width: 340px;">Estado</th>
                                        <th style="width: 400px;">Icono y Color</th>
                                        <th>Acción</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                            ...
                            <div id="tp2" class="tab-pane cont">
                                <div class="container">
                                    <form id="frmEstado_Tramite" method="post" data-parsley-validate="" data-parsley-excluded="[disabled=disabled]" novalidate="">
                                        ...
                                        <div class="row">
                                            <label for="cmbIcono" class="col-md-1 control-label">Icono</label>
                                            <div class="col-md-6">
                                                <select class="form-control" style="font-family: 'FontAwesome', 'Helvetica';" id="cmbIcono"  >
                                                    <option value="">---------</option>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function guardar(){
            ...
            if($("#frmEstado_Tramite").parsley().validate()){
                if (accion)
                    registrar()
                else
                    modificar()
        ...
        function registrar() {
            if (confirm("¿Deseas continuar el registro?")) {
                ...
                $.ajax({
                    url: "/intranet/mantenimientos/estado_tramite",
                    type: "POST",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
        ...
        function modificar() {
            if (confirm("¿Deseas continuar la modificación?")) {
                var info = obtenerDatos();
                $.ajax({
                    url: "/intranet/mantenimientos/estado_tramite/" + $("#hddCodigo").val(),
                    type: "PUT",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
        ...
        function eliminar(id) {
            if (confirm("¿Deseas eliminar el elemento?")) {
                ...
                $.ajax({
                    url: "/intranet/mantenimientos/estado_tramite/" + id,
                    type: "DELETE",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
        ...
        function cancelar(){
            ...
            $('#frmEstado_Tramite').parsley().reset();
            $('a[href="#tp1"]').click();
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data,function( index, value ) {
                        t.row.add([value['nombre'],"<i class='fa "+value["icono"]+"' style='color:"+value["color"]+";'></i>",
